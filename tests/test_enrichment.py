"""
Automated Pytest for arm-trustzone-smc-boundary-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    FirmwareEngine,
    SmcEngine,
    ArmtrustzonesmcboundaryagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ArmtrustzonesmcboundaryagentEnrichmentSuite()
