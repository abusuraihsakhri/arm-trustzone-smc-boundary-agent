...
import pytest
from arm_trustzone.models import FrontierPayload, ExecutionStatus
from arm_trustzone.engine import FrontierDomainEngine
from arm_trustzone.agents import SMCArgumentSanitizerAgent, WorldBoundaryMemoryAgent, SecureWorldExceptionAgent, TrustZoneCoordinator
from arm_trustzone.cli import main


def test_sub_agents():
    a1 = SMCArgumentSanitizerAgent()
...
def test_coordinator():
    ...
    assert "ARMv8-A / ARMv9-A TrustZone Architecture" in ans or "specifications" in ans
